function select_perfil(){
    ...
    appearence[3].style.display = "none";
    appearence[4].style.display = "none";
}
...
function select_config(){
    ...
    appearence[1].style.display = "none";
    appearence[2].style.display = "none";
    appearence[3].style.display = "inline";
    appearence[4].style.display = "none";
}
...
function select_change(){
    ...
    collection[1].style.backgroundColor = "red";
    collection[2].style.backgroundColor = "red";
    collection[3].style.backgroundColor = "pink";
    ...
    appearence[2].style.display = "none";
    appearence[3].style.display = "none";
    appearence[4].style.display = "inline";
}
